...
kdataset_salida  <- "paquete_premium_ext_723.csv.gz"
...
AgregarVariables  <- function( dataset )
{
  ...
  #Aqui debe usted agregar sus propias nuevas variables - SB
  
  dataset[ , sb_invcomunes         := mforex_buy + mplazo_fijo_pesos ]
  dataset[ , sb_call_hombk         := ccallcenter_trx / (1+chomebanking_trx) ]
