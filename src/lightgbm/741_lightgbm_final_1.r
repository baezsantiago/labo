...
#donde entrenar
kfinal_mes_desde    <- 201910        #mes desde donde entreno
...
kmax_bin           <-    31
klearning_rate     <-  0.0103627664273109
knum_iterations    <-   1113
knum_leaves        <-  567
kmin_data_in_leaf  <- 22070
kfeature_fraction  <- 0.786552768827208
