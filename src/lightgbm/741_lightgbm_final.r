...
kprefijo       <- "KA741_2"
ksemilla_azar  <- 800011  #Aqui poner la propia semilla
kdataset       <- "./datasets/paquete_premium_ext_721.csv.gz"

#donde entrenar
#OJO la BO se hizo con los meses 202007 a 202011

kfinal_mes_desde    <- 202005        #mes desde donde entreno
...
kmax_bin           <-    31
klearning_rate     <-     0.0116495678444781
knum_iterations    <-   690
knum_leaves        <-  2043
kmin_data_in_leaf  <- 6810
kfeature_fraction  <-     0.384346326068168
