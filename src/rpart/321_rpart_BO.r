...
hs  <- makeParamSet(
          ...
          makeIntegerParam("minsplit" , lower=  1000L  , upper= 5000L),  #la letra L al final significa ENTERO
          makeIntegerParam("minbucket", lower=  1L  , upper= 2500L),
          makeIntegerParam("maxdepth" , lower=  5L  , upper=   20L),
          forbidden = quote( minbucket > 0.5*minsplit ) )             # minbuket NO PUEDE ser mayor que la mitad de minsplit

ksemilla_azar  <- 800011   #cambiar por la primer semilla
